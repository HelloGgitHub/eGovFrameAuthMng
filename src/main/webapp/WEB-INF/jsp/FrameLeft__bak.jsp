...
<body>
	...
	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="btn_b"><a href="" onClick="fn_leftMenu(2);" title="권한목록 조회" style="font-size: 15px;font-style: inherit;font-weight: bold;">권한 목록 조회</a></span>
	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="btn_b"><a href="" onClick="fn_leftMenu(8);" title="권한 사용자 목록" style="font-size: 15px;font-style: inherit;font-weight: bold;">권한 사용자 등록</a></span>
	...
	<br/>
	<br/><span class="btn_b" style="font-size: 15px;font-style: inherit;font-weight: bold;">- 권한 메뉴 관리</span>
...
<!-- 	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="btn_b"><a href="" onClick="fn_leftMenu(10);" title="권한 메뉴 등록" style="font-size: 15px;font-style: inherit;font-weight: bold;">권한 메뉴 등록</a></span> -->
	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="btn_b"><a href="" onClick="fn_leftMenu(11);" title="권한그룹 메뉴 등록" style="font-size: 15px;font-style: inherit;font-weight: bold;">권한그룹 메뉴 등록</a></span>
<!-- 	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="btn_b"><a href="" onClick="fn_leftMenu(12);" title="권한그룹 메뉴 생성" style="font-size: 15px;font-style: inherit;font-weight: bold;">권한그룹 메뉴 생성</a></span> -->
